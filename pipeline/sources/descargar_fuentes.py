...
DESCARGAS: dict[str, list[tuple[str, str, str | None]]] = {
    ...
    "airbnb": [
        ...
        # Polígonos de los barrios de la ciudad. Es la única geometría de barrio disponible: el
        # ICGC llega a municipio (311 polígonos) y el PEUAT solo cubre sus 12 zonas, así que sin
        # esto el mapa de ciudad no puede agregar por barrio.
        (
            "geometria/insideairbnb_barrios_barcelona.geojson",
            "https://data.insideairbnb.com/spain/catalonia/barcelona/2026-06-24/visualisations/neighbourhoods.geojson",
            None,
        ),
    ],
}
