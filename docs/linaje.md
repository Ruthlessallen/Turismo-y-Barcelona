...
| `export/export_mapa.py` | export | geocodificacion_icgc.csv<br>restauracion_con_municipio.csv<br>vut_unificados.csv<br>airbnb_capacidad_latente.csv<br>airbnb_excluidos_web.csv<br>airbnb_para_web.csv<br>alojamientos_reglados.csv<br>sustitucion_resumen.csv<br>sustitucion_2028.csv | resumen.json<br>vut_por_barrio.json<br>vut_por_municipio.json |
...
| `gold/modelar_sustitucion.py` | gold | serie_ine_barcelona.csv<br>airbnb_para_web.csv<br>alojamientos_reglados.csv | sustitucion_resumen.csv<br>sustitucion_2028.csv |
