...
flowchart TD
  subgraph raw ["raw · descargas"]
    ...
    n_RAIZ_data_raw_restauracion_hoteles_provincia_bcn_terrasses_restauracio_2026_csv[("bcn_terrasses_restauracio_2026.csv")]
  ...
  n_RAIZ_data_raw_restauracion_hoteles_provincia_bcn_terrasses_restauracio_2026_csv --> n_gold_preparar_restauracion_bcn_py
...
| `gold/preparar_restauracion_bcn.py` | gold | bcn_cens_comercial_restauracion_2024.csv<br>bcn_terrasses_restauracio_2026.csv | restauracion_bcn.csv |
